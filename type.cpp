...
const QMap<const Number::Operations, QString> Number::operations_view
    = {{Number::Operations::Equal, "="},
       {Number::Operations::NotEqual, "<>"},
       {Number::Operations::Greater, ">"},
       {Number::Operations::Less, "<"},
       {Number::Operations::GreaterOrEqual, ">="},
       {Number::Operations::LessOrEqual, "<="}};
const QMap<const Number::Operations, std::function<bool(QVariant l, QVariant r)>>
    Number::operations_compare
    = {{Number::Operations::Equal,
        [](QVariant l, QVariant r) { return QVariant::compare(l, r) == 0; }},
       {Number::Operations::NotEqual,
        [](QVariant l, QVariant r) { return QVariant::compare(l, r) != 0; }},
       {Number::Operations::Greater,
        [](QVariant l, QVariant r) { return QVariant::compare(l, r) > 0; }},
...
bool Number::compareValue(QVariant left, QVariant right, const QString &operation) const
{
    ...
    return (operations_compare.contains(op)) ? operations_compare[op](left.toDouble(), right.toDouble()) : false;
}
...
const QMap<const String::Operations, QString> String::operations_view = {
    {String::Operations::StartsWith, "Начинается с"},
    {String::Operations::EndsWith, "Заканчивается на"},
    {String::Operations::Contains, "Содержит"},
};
const QMap<const String::Operations, std::function<bool(QString l, QString r)>>
    String::operations_compare = {
        {String::Operations::StartsWith,
         [](QString l, QString r) { return l.indexOf(r, 0, Qt::CaseInsensitive) == 0; }},
        {String::Operations::EndsWith,
         [](QString l, QString r) {
             return l.size() - l.indexOf(r, 0, Qt::CaseInsensitive) == r.size();
         }},
        {String::Operations::Contains,
         [](QString l, QString r) { return l.indexOf(r, 0, Qt::CaseInsensitive) != -1; }},
};
...
bool String::compareValue(QVariant left, QVariant right, const QString &operation) const
{
    ...
    if (left.userType() == QMetaType::QString && right.userType() == QMetaType::QString)
        return (operations_compare.contains(op))
                   ? operations_compare[op](left.toString(), right.toString())
                   : false;
    return false;
}
